...
export const IMPLEMENTATION_GUIDE = generateHowToSchema({
    guideUrl: "https://www.noorranklabs.com/documentation",
    ...
    steps: [
        ...
        },
        {
            ...
            url: "https://www.noorranklabs.com/documentation#step4"
        }
    ]
});
